...
Referência: 
	...
	http://tinyvga.com/vga-timing/640x480@141Hz
...
module contagem(
   ...
   vga_r, vga_g, vga_b   
	...
	input sel;
	input [4:1] decimo;
	input [4:1] uni_segundo;
	input [4:1] dec_segundo;
	input [4:1] minuto;
   ...
   //******************Geração de clock interno***********************
	...
	begin
	    ...
	    draw_bg(WHITE);
		 ...
		 draw_sqr(TOP_X, ESQ_Y, 1, BLACK);
		 
		 draw_T(TOP_X, 185, 1, RED);
		 draw_E(TOP_X+17, 185, 1, RED);
		 draw_M(TOP_X+32, 185, 1, RED);
		 draw_P(TOP_X+54, 185, 1, RED);
		 draw_O(TOP_X+67, 185, 1, RED);
		 draw_2Pontos(TOP_X+80, 185, 1, RED);
		 
		 case(minuto)
			0: draw_0(TOP_X+86,185,1,BLUE);
			1: draw_1(TOP_X+86,185,1,BLUE);
			2: draw_2(TOP_X+86,185,1,BLUE);
			3: draw_3(TOP_X+86,185,1,BLUE);
			4: draw_4(TOP_X+86,185,1,BLUE);
			5: draw_5(TOP_X+86,185,1,BLUE);
			6: draw_6(TOP_X+86,185,1,BLUE);
			7: draw_7(TOP_X+86,185,1,BLUE);
			8: draw_8(TOP_X+86,185,1,BLUE);
			9: draw_9(TOP_X+86,185,1,BLUE);
		endcase
		draw_2Pontos(TOP_X + 101,185,1,BLUE);
		case(dec_segundo)
			0: draw_0(TOP_X+106,185,1,BLUE);
			1: draw_1(TOP_X+106,185,1,BLUE);
			2: draw_2(TOP_X+106,185,1,BLUE);
			3: draw_3(TOP_X+106,185,1,BLUE);
			4: draw_4(TOP_X+106,185,1,BLUE);
			5: draw_5(TOP_X+106,185,1,BLUE);
			6: draw_6(TOP_X+106,185,1,BLUE);
			7: draw_7(TOP_X+106,185,1,BLUE);
			8: draw_8(TOP_X+106,185,1,BLUE);
			9: draw_9(TOP_X+106,185,1,BLUE);
		endcase
		case(uni_segundo)
			0: draw_0(TOP_X+121,185,1,BLUE);
			1: draw_1(TOP_X+121,185,1,BLUE);
			2: draw_2(TOP_X+121,185,1,BLUE);
			3: draw_3(TOP_X+121,185,1,BLUE);
			4: draw_4(TOP_X+121,185,1,BLUE);
			5: draw_5(TOP_X+121,185,1,BLUE);
			6: draw_6(TOP_X+121,185,1,BLUE);
			7: draw_7(TOP_X+121,185,1,BLUE);
			8: draw_8(TOP_X+121,185,1,BLUE);
			9: draw_9(TOP_X+121,185,1,BLUE);
		endcase
		draw_2Pontos(TOP_X + 136,185,1,BLUE);
		case(decimo)
			0: draw_0(TOP_X+141,185,1,BLUE);
			1: draw_1(TOP_X+141,185,1,BLUE);
			2: draw_2(TOP_X+141,185,1,BLUE);
			3: draw_3(TOP_X+141,185,1,BLUE);
			4: draw_4(TOP_X+141,185,1,BLUE);
			5: draw_5(TOP_X+141,185,1,BLUE);
			6: draw_6(TOP_X+141,185,1,BLUE);
			7: draw_7(TOP_X+141,185,1,BLUE);
			8: draw_8(TOP_X+141,185,1,BLUE);
			9: draw_9(TOP_X+141,185,1,BLUE);
		endcase
