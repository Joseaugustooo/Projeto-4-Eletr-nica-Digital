   ...
   //******************Geração de clock interno***********************
	...
	begin
	    ...
	    draw_bg(BLACK);
		 ...
		 draw_F(TOP_X+82, ESQ_Y+89, 1, WHITE);
		 draw_R(TOP_X+96, ESQ_Y+89, 1, WHITE);
		 draw_E(TOP_X+108, ESQ_Y+89, 1, WHITE);
		 draw_R(TOP_X+122, ESQ_Y+89, 1, WHITE);		
		 draw_E(TOP_X+134, ESQ_Y+89, 1, WHITE);
		 
		 draw_J(TOP_X+151, ESQ_Y+89, 1, WHITE);
		 draw_A(TOP_X+161, ESQ_Y+89, 1, WHITE);		
		 draw_C(TOP_X+173, ESQ_Y+89, 1, WHITE);
		 draw_Q(TOP_X+186, ESQ_Y+89, 1, WHITE);
		 draw_U(TOP_X+198, ESQ_Y+89, 1, WHITE);
		 draw_E(TOP_X+210, ESQ_Y+89, 1, WHITE);
		 ...
		 draw_P(TOP_X+82, ESQ_Y+114, 1, WHITE);
		 draw_O(TOP_X+94, ESQ_Y+114, 1, WHITE);
		 draw_P(TOP_X+106, ESQ_Y+114, 1, WHITE);	
		 draw_U(TOP_X+118, ESQ_Y+114, 1, WHITE);
		 draw_L(TOP_X+130, ESQ_Y+114, 1, WHITE);
		 draw_A(TOP_X+142, ESQ_Y+114, 1, WHITE);
		 draw_R(TOP_X+154, ESQ_Y+114, 1, WHITE);
		 
		 draw_F(TOP_X+169, ESQ_Y+114, 1, WHITE);
		 draw_R(TOP_X+183, ESQ_Y+114, 1, WHITE);
		 draw_A(TOP_X+195, ESQ_Y+114, 1, WHITE);
		 draw_N(TOP_X+207, ESQ_Y+114, 1, WHITE);
		 draw_C(TOP_X+224, ESQ_Y+114, 1, WHITE);
		 draw_E(TOP_X+237, ESQ_Y+114, 1, WHITE);
		 draw_S(TOP_X+251, ESQ_Y+114, 1, WHITE);
		 draw_A(TOP_X+264, ESQ_Y+114, 1, WHITE);
